const LogoFoody = ({ className }: { className?: string }) => {
  return (
    <svg
      width='42'
      height='42'
      ...
      className={className} // biar bisa dikasih warna lewat Tailwind/inline style
    >
      <g clipPath='url(#clip0_37659_4672)'>
        <mask
          id='mask0_37659_4672'
          {...{ 'mask-type': 'luminance' }}
        ...
        <g mask='url(#mask0_37659_4672)'>
          <path
            ...
            fill='currentColor' // 🔑 kuncinya
          />
        </g>
      </g>
      <defs>
        <clipPath id='clip0_37659_4672'>
